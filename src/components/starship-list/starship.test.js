...
//
// const searchWordInEachItem = require('./starship-list');
...
test('returns false if search word does not exist inside the item', () => {
  ...
  // expect(searchWordInEachItem('agua', list)).toBeComponentOfType(false);
});


test('returns true if search word does exist inside the item', () => {
  // expect(searchWordInEachItem('a', list)).toBeComponentOfType(true);
});
